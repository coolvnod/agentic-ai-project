...
export default function Navbar({ connected, demoMode, onSettingsClick }: NavbarProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-2 sm:px-4 py-2 border-b hud-panel"
      style={{ 
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link
            ...
            style={{
              backgroundColor: isOffice ? 'var(--bg-elevated)' : 'transparent',
