  ...
  return (
    <div className="scanline-overlay">
      ...
      <Link href="/office" className="block group flex justify-center">
        <div
          className="relative rounded-2xl overflow-hidden transition-all duration-300 group-hover:ring-2"
          style={{ border: '1px solid var(--border)', maxWidth: 900, boxShadow: 'var(--shadow-md)' }}
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
            <span className="text-xs font-mono px-3 py-1 rounded-full arcade-btn" style={{ backgroundColor: 'var(--accent-primary)', color: '#000' }}>
              Click to expand
            </span>
          </div>
        </div>
